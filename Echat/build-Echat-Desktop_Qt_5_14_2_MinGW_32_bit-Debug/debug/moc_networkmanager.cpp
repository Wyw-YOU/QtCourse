...
#include <memory>
#include "../../Echat/networkmanager.h"
...
QT_MOC_LITERAL(5, 58, 9), // "DataReach"
QT_MOC_LITERAL(6, 68, 11), // "onConnected"
QT_MOC_LITERAL(7, 80, 14), // "onDisconnected"
QT_MOC_LITERAL(8, 95, 11) // "onreadyRead"

    },
    "NetworkManager\0connectionStatusChanged\0"
    "\0connected\0message\0DataReach\0onConnected\0"
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectionStatusChanged((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->DataReach(); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkManager::DataReach)) {
                *result = 1;
                return;
            }
        }
