...
QT_MOC_LITERAL(1, 12, 18), // "currentUserChanged"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "DataManager\0currentUserChanged\0"
};
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::currentUserChanged)) {
                *result = 0;
                return;
            }
        }
